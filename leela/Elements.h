...
PlanetInfo planetInfo[] = {
    ...
    {  "Mars",      "Sun",      {},         60,     0,          0.02f,     270.0f,      25.0f,      7000,   0,      0.0006f,    0.0f,       1.85f,      {0.85f, 0.5f, 0.5f},    "low",      "mars2k.png"                    },
    {  "Jupiter",   "Sun",      {},         140,    0,          0.02f,     270.0f,      3.1f,       11000,  280.0f, 0.0004f,    0.0f,       1.31f,      {0.85f, 0.7f, 0.6f},    "low",      "jupiter2k.png"                 },
    {  "Saturn",    "Sun",      {},         110,    0,          0.02f,     270.0f,      26.7f,      15000,  220.0f, 0.0002f,    0.0f,       2.49f,      {0.7f, 0.7f, 0.4f},     "low",      "saturn2k.png"                  },
    {  "Uranus",    "Sun",      {},         90,     0,          0.02f,     270.0f,      97.7f,      20000,  18.0f,  0.0001f,    0.0f,       0.77f,      {0.7f, 0.7f, 0.85f},    "low",      "uranus2k.png"                  },
    {  "Neptune",   "Sun",      {},         80,     0,          0.02f,     270.0f,      28.0f,      25000,  150.0f, 0.00008f,   0.0f,       1.77f,      {0.4f, 0.4f, 0.9f},     "low",      "neptune2k.png"                 }
};
